...
CREATE TABLE `bill_history` (
  `id_bill_history` int(11) NOT NULL AUTO_INCREMENT,
  `claim_no` varchar(45) NOT NULL,
  `amount` varchar(45) NOT NULL,
  `create_date` datetime DEFAULT NULL,
  `create_by` varchar(45) DEFAULT NULL,
  `claim_info_id` int(11) NOT NULL,
...
INSERT INTO `bill_history` VALUES (4,'1111','50000','2018-07-15 18:00:09',NULL,10);
